...
public class IMFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/investigations.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/companies.png"))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "InvestigationID", "Policy No", "Claim No" }));

        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/search.png"))); // NOI18N
        jButton4.setBorder(null);

        jComboBox2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Company ID", "Company Name", "Representative Name" }));
